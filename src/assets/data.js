...
// Priority flag data
export const flags = [
  { flagId: 1, name: "Low", color: "#00FF00" }, // Green - Low priority
  { flagId: 2, name: "Medium", color: "#FFA500" }, // Orange - Medium priority
  { flagId: 3, name: "High", color: "#FF0000" }, // Red - High priority
];
